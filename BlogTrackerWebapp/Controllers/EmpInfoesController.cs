...
namespace BlogTrackerWebapp.Controllers
{
    public class EmpInfoesController : Controller
    {
        ...
        public EmpInfoesController(CapstoneProjectDbContext context)
        {
            _context = context;
        }
        [HttpGet]
        ...
        public async Task<IActionResult> Index()
        {
              return _context.EmpInfo != null ? 
                          ...
                          Problem("Entity set 'CapstoneProjectDbContext.EmpInfo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'CapstoneProjectDbContext.EmpInfo'  is null.");
            }
            var empInfo = await _context.EmpInfo.FindAsync(id);
            if (empInfo != null)
            {
