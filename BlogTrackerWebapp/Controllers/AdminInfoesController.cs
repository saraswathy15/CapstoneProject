...
namespace BlogTrackerWebapp.Controllers
{
    public class AdminInfoesController : Controller
    {
        ...
        public AdminInfoesController(CapstoneProjectDbContext context)
        {
            _context = context;
        }
        [HttpGet]
        ...
        public async Task<IActionResult> Index()
        {
              return _context.AdminInfo != null ? 
                          ...
                          Problem("Entity set 'CapstoneProjectDbContext.AdminInfo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'CapstoneProjectDbContext.AdminInfo'  is null.");
            }
            var adminInfo = await _context.AdminInfo.FindAsync(id);
            if (adminInfo != null)
            {
